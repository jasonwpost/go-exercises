// Nice 3rd party package for routing - shows the request,
// path, and function all quite clearly and organised
// nicely. It also has great benchmarks.
...
func main(){
  mux := httprouter.New()
  // Paths need to be exact - unlike the standard library mux
  // i.e. adding a trailing / to any of these will not redirect
  // back to the path. ex. /about/ will not redirect to /about
  mux.GET("/", index)
  mux.GET("/about", about)
